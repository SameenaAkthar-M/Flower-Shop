...
const Navbar = () => {
  ...
  useGSAP(() => {
    ...
    .from(gsap.utils.toArray(".nav-right > *:not(.cart)"), {
      y: 30,
      opacity: 0,
      stagger: 0.1,
    }, "-=0.2")
  ...
  return (
    <nav ref={navRef} className='navbar'>
      ...
      <div className={`cart ${activeLink === "cart" ? "cart-active" : ""}`} onClick={() => {
        setActiveLink("cart");
        navigate('/cart');
      }}>
      <FaCartShopping className={`icon ${activeLink === "cart" ? "icon-active" : ""}`} />
